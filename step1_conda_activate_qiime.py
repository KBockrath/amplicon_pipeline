...
os.system('/bin/bash -c "source activate qiime1 && exec python step1.py test*_R1_001.fastq.gz test*_R2_001.fastq.gz test 160408_NB501144_0002_AHMFMNBGXX Loons_Long_Tailed"')